...
export default function GeofencesPage() {
  ...
  const rowActions: RowAction<Geofence>[] = [
    {
      key: "update",
      label: "Tahrirlash",
      icon: Pencil,
      permission: "hr-geofences.update",
      onSelect: (g) => {
        setEditing(g);
        setDrawerOpen(true);
      },
    },
    {
      ...
      icon: Trash2,
      tone: "danger",
      permission: "hr-geofences.delete",
      onSelect: (g) => setDeleting(g),
    },
  ];
  ...
  return (
    <div className="stagger">
      <PageHeader
        ...
        action={
          <Can permission="hr-geofences.create">
            <Button
              variant="accent"
              onClick={() => {
                setEditing(null);
              ...
              {isLoading ? (
                ...
                rows.map((g, i) => (
                  <tr key={g.id} className="border-b border-line/60 last:border-0">
                    ...
                    {showActions && (
                      <td className="px-4 py-3">
                        <RowActions row={g} actions={rowActions} />
                      </td>
                    )}
                  </tr>
                ))

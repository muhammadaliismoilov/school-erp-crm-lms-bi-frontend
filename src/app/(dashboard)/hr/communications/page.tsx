...
export default function CommunicationsPage() {
  ...
  const rowActions: RowAction<Interaction>[] = [
    {
      key: "update",
      label: "Tahrirlash",
      icon: Pencil,
      permission: "hr-interactions.update",
      onSelect: (it) => {
        setEditing(it);
        setDrawerOpen(true);
      },
    },
    {
      ...
      icon: Trash2,
      tone: "danger",
      permission: "hr-interactions.delete",
      onSelect: (it) => setDeleting(it),
    },
  ];
  ...
  return (
    <div className="stagger">
      <PageHeader
        ...
        action={
          <Can permission="hr-interactions.create">
            <Button
              variant="accent"
              onClick={() => {
                setEditing(null);
              ...
              {isLoading ? (
                ...
                rows.map((it, i) => (
                  <tr key={it.id} className="border-b border-line/60 last:border-0">
                    ...
                    {showActions && (
                      <td className="px-4 py-3">
                        <RowActions row={it} actions={rowActions} />
                      </td>
                    )}
                  </tr>
                ))
